...
public final class JPackage implements JDeclaration, JGenerable, JClassContainer, JAnnotatable, Comparable<JPackage>, JDocCommentable {
    ...
    private List<String> importstmts;
    
    public List<String> getImportstmts() {
		return importstmts;
	}

	public void setImportstmts(List<String> importstmts) {
    ...
    private JFormatter createJavaSourceFileWriter(CodeWriter src, String className) throws IOException {
        ...
        JFormatter formatter = new JFormatter(new PrintWriter(bw));
        if(importstmts != null && !importstmts.isEmpty()){
        	//TODO 添加导入语句
        	formatter.setImportstmts(this.getImportstmts());
        }
        return formatter;
    }
}
